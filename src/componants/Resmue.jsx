...
const Resmue = () => {
  return (
    <div id='Resmue' className=' bg-resume w-full h-[110%] md:w-full md:h-full bg-cover bg-no-repeat after:absolute after:w-full after:h-[115%] after:md:w-full md:after:h-full after:bg-black after:opacity-[0.9] after:z-0 '>
